<template>
    <div class="reviews__box">
        <div class="title">{{ translate('reviewsTitle') }}</div>
        <div class="buttons">
            <button class="btn" @click="add()">{{ translate('btnAddReviews') }}</button>
            <select class="btn" v-model="selectedOptionTime" @change="selectChangeTime">
                <option value="startTime" disabled hidden>{{ translate('btnSortByTime') }}</option>
                <option value="old">{{ translate('firstNew') }}</option>
                <option value="new">{{ translate('firstOld') }}</option>
            </select>
            <select class="btn" v-model="selectedOptionRating" @change="selectChangeRating">
                <option value="startRating" disabled hidden>{{ translate('btnSortByRating') }}</option>
                <option value="firstGood" selected>{{ translate('firstGood') }}</option>
                <option value="firstBad">{{ translate('firstBad') }}</option>
            </select>
        </div>
